...
namespace Sabim.Services.Validators.MalzemeValidators
{
    public class CreateMalzemeValidator : AbstractValidator<CreateMalzemeDto>
    {
        private readonly IServiceManager _manager;
        public CreateMalzemeValidator(IServiceManager manager)
        {
            _manager = manager;
            ...
            RuleFor(x => x.SeriNumarasi)
                ...
                .Must(BeUniqueSerialNumber).WithMessage("Bu seri numarası zaten kayıtlı!");
        ...
        private bool BeUniqueSerialNumber(string seriNumarasi)
        {
            return !_manager.MalzemeService.TIsAny(x => x.SeriNumarasi == seriNumarasi);
        }
    }
}
