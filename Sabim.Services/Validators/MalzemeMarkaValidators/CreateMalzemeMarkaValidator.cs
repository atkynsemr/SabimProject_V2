    ...
    public class CreateMalzemeMarkaValidator : AbstractValidator<CreateMalzemeMarkaDto>
    {
        ...
        public CreateMalzemeMarkaValidator(IServiceManager manager)
        {
            ...
            RuleFor(x => x.MarkaAdi)
                ...
                .Must((model, markaAdi) => BeUniqueName(markaAdi, model.MalzemeCinsiId))
        ...
        private bool BeUniqueName(string markaAdi, byte malzemeCinsiId)
        {
            return !_manager.MalzemeMarkaService.TIsAny(x =>
                x.MarkaAdi == markaAdi && x.MalzemeCinsiId == malzemeCinsiId);
        }
    }
}
