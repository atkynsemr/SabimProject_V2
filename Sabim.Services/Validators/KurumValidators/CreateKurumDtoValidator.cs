...
{
    public class CreateKurumDtoValidator : AbstractValidator<CreateKurumDto>
    {
        private readonly IServiceManager _manager;
        public CreateKurumDtoValidator(IServiceManager manager)
        {
            _manager = manager;
            RuleFor(x => x.KurumAdi)
                ...
                .Must((dto, kurumAdi) => BeUniqueName(kurumAdi, dto.SehirId))
        ...
        private bool BeUniqueName(string kurumAdi, short sehirId)
        {
            return !_manager.KurumService.TIsKurumExists(kurumAdi,sehirId);
        }
    }
}
